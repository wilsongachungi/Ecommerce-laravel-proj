...
const deleteBrand = (brand, index)=>{
    Swal.fire({
        ...
        if(result.isConfirmed) {
            try{
                router.delete('/admin/brands/destroy/' + brand.id, {
                    onSuccess : (page)=>{
                        Swal.fire({
                    toast: true,
                    icon: 'success',
            ...
            <form  @submit.prevent="editMode ? updateBrand() :addBrand()" class="max-w-md mx-auto">
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="floating_name"
                        class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Brand Name</label>
                </div>
                <button type="submit"
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr v-for="brand in brands" :key="brand.id"
                                    ...
                                    <td class="px-4 py-3">{{ new Date(brand.created_at).toLocaleDateString() }}</td>
                                    <td class="">
                                    ...
                                    <div :id="`${brand.id}`"
                                        ...
                                        <div class="py-1">
                                            <button  @click="deleteBrand(brand, index)"
